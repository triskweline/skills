...
Once the test suite passes, you should also run any linter tools you discovered earlier.
...
When you have fixed a linting issue, re-run the linter tool that complained. Don't rerun the entire test suite (slow!) after fixing a linter complaint.
