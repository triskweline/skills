...
It is then enough to have an E2E test for the key scenarios (valid form submits, invalid form shows error messages), without re-iterating all the possible.
